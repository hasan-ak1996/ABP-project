...
namespace AbpIoTest.Migrations
{
    ...
    [Migration("20201210170352_update25-database")]
    partial class update25database
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttachmentDetail.AttachmentDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AttachmentMasterId")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TemporaryStatus")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("Id");

                    b.HasIndex("AttachmentMasterId");

                    b.ToTable("AppAttachmentDetail");
                });

            modelBuilder.Entity("AttachmentMasterFolder.AttachmentMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppAttachmentMaster");
                });

            modelBuilder.Entity("ItemEntity.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderEntity.Order", b =>
                {
                    ...
                    b.Property<int?>("AttachmentMasterId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AttachmentMasterId1");
            ...
            modelBuilder.Entity("AttachmentDetail.AttachmentDetail", b =>
                {
                    b.HasOne("AttachmentMasterFolder.AttachmentMaster", "AttachmentMaster")
                        .WithMany("Files")
                        .HasForeignKey("AttachmentMasterId")
            ...
            modelBuilder.Entity("ItemEntity.Item", b =>
                {
                    b.HasOne("OrderEntity.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrderEntity.Order", b =>
                {
                    b.HasOne("AttachmentMasterFolder.AttachmentMaster", null)
                        .WithMany()
                        .HasForeignKey("AttachmentMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("AttachmentMasterFolder.AttachmentMaster", "AttachmentMaster")
                        .WithMany()
                        .HasForeignKey("AttachmentMasterId1");
